...
#include <include/cam/camera_models/geometric_camera.h>
...
class EdgeSim3ProjectXYZ
    : public g2o::BaseBinaryEdge<2, Eigen::Vector2d, g2o::VertexSBAPointXYZ,
                                 ORB_SLAM_FUSION::VertexSim3Expmap> {
 public:
  EIGEN_MAKE_ALIGNED_OPERATOR_NEW
  EdgeSim3ProjectXYZ();
  virtual bool read(std::istream& is);
  ...
  void computeError() {
    const ORB_SLAM_FUSION::VertexSim3Expmap* v1 =
        static_cast<const ORB_SLAM_FUSION::VertexSim3Expmap*>(_vertices[1]);
    const g2o::VertexSBAPointXYZ* v2 =
        static_cast<const g2o::VertexSBAPointXYZ*>(_vertices[0]);
